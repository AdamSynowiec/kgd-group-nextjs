...
/**
 * Rejestr sekcji dla szablonu "krj307-2" — mirror starego
 * src/components/templates/krj307-2/template.js.
 *
 * "example" celowo nie ma tu wpisu — w źródłowym projekcie też nigdy nie
 * miał komponentu w template.js (fields: {} i tak puste), więc się nie
 * renderował.
 */
