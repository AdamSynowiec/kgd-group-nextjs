...
export default function Gallery({ fields }: { fields: GalleryFields }) {
  ...
  return (
    <div id="wizualizacje" className="bg-[#1C1D21] text-white overflow-hidden">
      <Container>
        <h2 className="text-[#FCFCFC] font-ranade-variable text-[40px] md:text-[48px] py-[50px] md:py-[100px]">{header}</h2>
      </Container>
          ...
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex">
              {images.map((img, index) => (
                <div key={img.path} className="min-w-[80%] md:min-w-[60%] lg:min-w-[60%] pl-3 pr-3">
                  <div onClick={() => handleImageClick(index)} className="group relative aspect-[16/9] overflow-hidden cursor-pointer bg-black/20">
