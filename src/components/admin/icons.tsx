...
export function BlogIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" className={className} aria-hidden>
      <path d="M4 19.5V6a2 2 0 0 1 2-2h9l5 5v10.5a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 19.5Z" strokeLinejoin="round" />
      <path d="M15 4v4.5A1.5 1.5 0 0 0 16.5 10H20" strokeLinejoin="round" />
      <path d="M8 12.5h6M8 15.5h8M8 9.5h4" strokeLinecap="round" />
    </svg>
  );
}
